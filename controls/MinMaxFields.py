...
def create_x_minmax_field(self):
    ...
    # Xmin input field
    x_min_enter = TextEntry(self, self.current_module.plot.x_min)
    ...
    # Xmax input field
    x_max_enter = TextEntry(self, self.current_module.plot.x_max)
...
def create_y_minmax_field(self):
    ...
    # Ymin input field
    y_min_enter = TextEntry(self, self.current_module.plot.y_min)
    ...
    # Ymax input field
    y_max_enter = TextEntry(self, self.current_module.plot.y_max)
